...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`collabJunction`}</title>

        <meta
          name="description"
          content="Welcome to collabJunction, your ultimate collaboration platform where you can seamlessly connect, interact, and create with others."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb2xsYWJvcmF0aW9ufGVufDB8fHx8MTY5NjM0NDk2OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to collabJunction, your ultimate collaboration platform where you can seamlessly connect, interact, and create with others.`}
            </Text>
            <Box
